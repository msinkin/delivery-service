    ...
    <footer className="p-6">
      <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 className="mb-6 text-sm font-semibold text-blue-500 uppercase">
              Resources
            </h2>
      ...
      <div className="sm:flex sm:items-center sm:justify-between mt-12">
        <span className="text-sm text-blue-300 sm:text-center dark:text-gray-400">
          © 2023 Tensei™. Все права зашищены.
        </span>
